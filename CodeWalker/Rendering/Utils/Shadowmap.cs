...
namespace CodeWalker.Rendering
{
    public class Shadowmap
    {
        ...
        {
            TextureSize = 2048; // Safe High Fidelity: 2K Shadow Maps
            CascadeCount = 4; // Safe High Fidelity: Default cascades
            PCFSize = 3; // Safe High Fidelity: Standard soft shadows
