...
namespace CodeWalker.Rendering
{
    ...
    public class PostProcessor
    {
        ...
        public float LumBlendSpeed = 2.5f; // High Fidelity: Faster eye adaptation
        ...
        public PostProcessor(DXManager dxman)
        {
            ...
            GetSampleWeights(ref FilterVCSVars.Vars.avSampleWeights, 5.0f, 1.5f); // High Fidelity: Softer & Stronger Bloom
