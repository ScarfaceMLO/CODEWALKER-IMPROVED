...
namespace CodeWalker
{
    public partial class ExploreForm : Form
    {
        ...
        public ExploreForm()
        {
            ...
            if (Settings.Default.ExplorerWindowTheme == "Windows")
            {
                Settings.Default.ExplorerWindowTheme = "Dark";
            }
